...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < ws.getDisplays().size(); i++) {
			System.out.println("Display " + (i + 1) + ":");
			System.out.println("Temperature: " + ws.getDisplays().get(i).getTemperature());
			System.out.println("AirPressure: " + ws.getDisplays().get(i).getAirPressure());
			System.out.println("--");
		}
